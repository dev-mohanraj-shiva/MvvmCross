...
The easiest way to start a new MvvmCross based project is to use Placeholder's [MvxScaffolding](https://github.com/Plac3hold3r/MvxScaffolding) templates. This guide will use the commandline version as it can be utilized by both Windows and macOS users.
